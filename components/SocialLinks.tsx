...
// lucide-react@1.27.0 (the version pinned in package.json) no longer ships
// brand/logo icons such as Github and Linkedin — those were dropped from the
// library upstream. Mail/Download (used here and in ResumeButton) are
// unaffected generic icons. We inline minimal brand-mark SVGs here instead
// of adding a new icon-package dependency.
const linkClassName =
